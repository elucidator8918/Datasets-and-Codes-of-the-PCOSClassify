# Datasets and Codes of the PCOSGen: An ultrasound imaging-based dataset and its benchmarking for automatic classification of polyp cystic ovary syndrome

This repository contains the datasets and codes utilized in the manuscript titled 'PCOSGen: An ultrasound imaging-based dataset and its benchmarking for automatic classification of polyp cystic ovary syndrome'. At first, the codes utilized to benchmark the PCOSGen train and test dataset have been discussed. It is a binary classification. The binary-labels based dataset was utilized in the Auto-PCOS Classification challenge. An extended version of the dataset which contains multi-labels has also been now released and benchmarked. The benchmarking codes of the multi-label classification have been put in a second folder. A third dataset, the tabular dataset collected by the team has also been released and discussed in this gtihub repository. 
